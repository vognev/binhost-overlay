...
src_compile() {
	...
	export RUSTFLAGS="-Z force-unstable-if-unmarked -C linker=x86_64-pc-linux-musl-clang -C link-arg=--sysroot=/usr/x86_64-pc-linux-musl -C link-arg=--rtlib=compiler-rt"
